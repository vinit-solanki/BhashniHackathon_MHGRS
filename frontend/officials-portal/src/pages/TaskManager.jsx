...
import { 
  Sparkles, Clock, Users, Target, AlertTriangle, Brain,
  BarChart2, Briefcase, Calendar, TrendingUp, CheckCircle2
} from 'lucide-react';
      ...
      <div className="max-w-7xl mx-auto space-y-6">
        ...
        <div className="flex justify-between items-center">
          <div>
            ...
            <p className="text-gray-600 dark:text-gray-400 mt-1">
              Overview of all department tasks and resource allocation
            </p>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
          {[
            ...
            >
              <div className={`w-12 h-12 rounded-lg bg-${stat.color}-100 dark:bg-${stat.color}-900/30 
